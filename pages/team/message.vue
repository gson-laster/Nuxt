<template>
    <div class="box">
      ...
      <div class="content-list">
        <ul>
          <!-- <li class="item">
            <div class="avatar"><img src="~static/img/test.jpg" alt=""></div>
            <div class="content">
              <div class="left">
              <p class="name">阿里里</p>
              <p class="text">OK,我已经加你微信了,微信聊</p>
            </div>
              <p class="time">12:30</p>
            </div>
          </li>
           <li class="item">
            <div class="avatar"><img src="~static/img/test.jpg" alt="" class="grayscale"></div>
            <div class="content">
              <div class="left">
              <p class="name">阿里里</p>
              <p class="text">OK,我已经加你微信了,微信聊</p>
          ...
          <nuxt-link tag="li" class="item" :to="{path:'/team/chat',query:setQuery()}" v-for="(item,index) in contact" :key="index">
