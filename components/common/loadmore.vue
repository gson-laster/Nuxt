  ...
  <div class="mint-loadmore-content"
    ...
    <slot name="top">
      <div class="mint-loadmore-top"
           v-if="topMethod">
        <spinner v-if="topStatus === 'loading'"
    ...
    <slot name="bottom">
      <div class="mint-loadmore-bottom"
           v-if="bottomMethod">
        <spinner v-if="bottomStatus === 'loading'"
                 class="mint-loadmore-spinner"
                 :size="20"
                 type="fading-circle"></spinner>
  ...
  watch: {
    ...
    bottomStatus(val) {
      ...
      case 'loading':
        ...
        break;
      case 'loaded':
        this.bottomText = this.allLoadText
        break;
      }
    }
  },
  ...
  methods: {
    ...
    fillContainer() {
      if (this.autoFill) {
        this.$nextTick(() => {
          if (this.scrollEventTarget === window) {
            this.containerFilled = this.$el.getBoundingClientRect()
              .bottom >=
    ...
    checkBottomReached() {
      if (this.scrollEventTarget === window) {
        ...
        return this.$el.getBoundingClientRect()
          .bottom <= this.scrollEventTarget.getBoundingClientRect()
          .bottom + 1;
      }
    },
    ...
    handleTouchMove(event) {
      ...
      if (typeof this.bottomMethod === 'function' && this.direction === 'up' &&
        ...
        this.bottomStatus = !this.allLoaded ? (-this.translate >= this.bottomDistance ? 'drop' : 'pull') : 'loaded';
      }
